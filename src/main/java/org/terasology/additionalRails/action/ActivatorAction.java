...
/**
 * System, which covers the Activator Rail behavior. The
 * {@link org.terasology.additionalRails.events.CartActivatedEvent}
 * is called to every cart, which enters the Activator Rail.
 * {@link org.terasology.additionalRails.events.CartDeactivatedEvent}
 * is called, when a cart leaves the rail.
 *
...
public class ActivatorAction extends BaseComponentSystem {
    ...
    /**
     * We're listening for {@link org.terasology.segmentedpaths.events.OnVisitSegment} event, which is called when a
     * cart enters the rail. Next, the {@link org.terasology.additionalRails.events.CartActivatedEvent} is called on the
     * entity which entered the rail.
     *
    ...
    /**
     * We're listening for {@link org.terasology.segmentedpaths.events.OnExitSegment} event, which is called when a cart
     * leaves the rail. Next, the {@link org.terasology.additionalRails.events.CartDeactivatedEvent} is called on the
     * entity which left the rail.
     *
